...
3. ⛔️ Valida o parametro **survey_id**
4. ⛔️ Valida se o campo **answer** é um resposta válido
...
4. ⛔️ Retorna erro **403** se resposta enviada pelo client for uma resposta inválida
